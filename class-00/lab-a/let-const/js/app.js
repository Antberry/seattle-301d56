...
function displayPics(){
  ...
  // The variable was called outside of the scope of let. Since let was declared inside a function that means it can only be called inside the function even if its a console.log().
